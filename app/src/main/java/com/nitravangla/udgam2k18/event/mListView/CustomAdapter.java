package com.nitravangla.udgam2k18.event.mListView;
...
public class CustomAdapter extends BaseAdapter {
    ...
    Context c;
    ArrayList<com.nitravangla.udgam_2k18.Events.event.mData.Day> days;
    LayoutInflater inflater;

    public CustomAdapter(Context c, ArrayList<com.nitravangla.udgam_2k18.Events.event.mData.Day> days) {
        this.c = c;
        this.days = days;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(c, com.nitravangla.udgam_2k18.Events.event.mData.eventDet.class);
